...
namespace AESP.Repository.Migrations
{
    ...
    [Migration("20251109113722_MoveStatusAndProgressToLearningPathCourse")]
    partial class MoveStatusAndProgressToLearningPathCourse
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AESP.Repository.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AvatarUrl = "",
                            CoinBalance = 0,
                            CreatedAt = new DateTime(2025, 11, 9, 11, 37, 21, 768, DateTimeKind.Utc).AddTicks(4609),
                            ...
                            Role = "ADMIN",
                            Status = "Active",
                            UpdatedAt = new DateTime(2025, 11, 9, 11, 37, 21, 768, DateTimeKind.Utc).AddTicks(4611)
                        });
                });
            ...
            modelBuilder.Entity("AESP.Repository.Models.Purchase", b =>
                {
                    ...
                    b.HasOne("AESP.Repository.Models.ReviewFee", null)
                        .WithMany("Purchases")
