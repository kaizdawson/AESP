...
namespace AESP.Repository.Migrations
{
    ...
    [Migration("20251218122735_AddFieldRelearnAndRemovePhonemeJsonInQuestion")]
    partial class AddFieldRelearnAndRemovePhonemeJsonInQuestion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AESP.Repository.Models.AIConversationCharge", b =>
                {
                    b.Property<Guid>("AIConversationChargeId")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("AESP.Repository.Models.LearnerAnswer", b =>
                {
                    ...
                    b.Property<string>("ExplainTheWrongForVoiceAI")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("IsNeededReviewed")
                        .HasColumnType("bit");

                    b.Property<Guid>("LearnerProfileId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("LearningPathQuestionId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AESP.Repository.Models.LearningPathQuestion", b =>
                {
                    b.Property<Guid>("LearningPathQuestionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("LearningPathQuestionId");

                    b.HasIndex("LearningPathExerciseId");

                    b.HasIndex("QuestionId");

                    b.ToTable("LearningPathQuestions");
                });
            ...
            modelBuilder.Entity("AESP.Repository.Models.Purchase", b =>
                {
                    ...
                    b.Property<decimal>("PercentOfReviewerAtPurchase")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("PricePerReviewAtPurchase")
                        .HasColumnType("decimal(18,2)");

                    b.Property<Guid?>("RecordChargeId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AIConversationChargeId");

                    b.HasIndex("CourseId");

                    b.HasIndex("LearnerProfileId");

                    b.HasIndex("RecordChargeId");
            ...
            modelBuilder.Entity("AESP.Repository.Models.RecordCharge", b =>
                {
                    ...
                    b.Property<int>("AllowedRecordCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AESP.Repository.Models.Review", b =>
                {
                    ...
                    b.Property<string>("RecordAudioUrl")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AESP.Repository.Models.ReviewFeeDetail", b =>
                {
                    b.Property<Guid>("ReviewFeeDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("ReviewFeeDetailId");

                    b.HasIndex("ReviewFeeId");

                    b.ToTable("ReviewFeeDetail");
                });
            ...
            modelBuilder.Entity("AESP.Repository.Models.ServicePackage", b =>
                {
                    ...
                    b.Property<int>("BaseNumberOfCoin")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AESP.Repository.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AvatarUrl = "",
                            CoinBalance = 0,
                            CreatedAt = new DateTime(2025, 12, 18, 19, 27, 34, 241, DateTimeKind.Unspecified).AddTicks(3461),
                            ...
                            Role = "ADMIN",
                            Status = "Active",
                            UpdatedAt = new DateTime(2025, 12, 18, 19, 27, 34, 241, DateTimeKind.Unspecified).AddTicks(3494)
                        },
                        new
                        {
                            ...
                            AvatarUrl = "",
                            CoinBalance = 0,
                            CreatedAt = new DateTime(2025, 12, 18, 19, 27, 34, 241, DateTimeKind.Unspecified).AddTicks(3603),
                            ...
                            Role = "ADMIN",
                            Status = "Active",
                            UpdatedAt = new DateTime(2025, 12, 18, 19, 27, 34, 241, DateTimeKind.Unspecified).AddTicks(3606)
                        });
                });
            ...
            modelBuilder.Entity("AESP.Repository.Models.LearnerAnswer", b =>
                {
                    ...
                    b.HasOne("AESP.Repository.Models.LearningPathQuestion", "LearningPathQuestion")
                        .WithMany("LearnerAnswers")
                        .HasForeignKey("LearningPathQuestionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("AESP.Repository.Models.LearningPathQuestion", b =>
                {
                    b.HasOne("AESP.Repository.Models.LearningPathExercise", "LearningPathExercise")
                        .WithMany("LearningPathQuestions")
                        .HasForeignKey("LearningPathExerciseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("LearningPathExercise");
            ...
            modelBuilder.Entity("AESP.Repository.Models.Purchase", b =>
                {
                    ...
                    b.HasOne("AESP.Repository.Models.LearnerProfile", null)
                        .WithMany("Purchases")
                        .HasForeignKey("LearnerProfileId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("AESP.Repository.Models.RecordCharge", "RecordCharge")
                        .WithMany("Purchases")
                        .HasForeignKey("RecordChargeId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("AIConversationCharge");

                    b.Navigation("Course");

                    b.Navigation("RecordCharge");
            ...
            modelBuilder.Entity("AESP.Repository.Models.LearningPathExercise", b =>
                {
                    b.Navigation("LearningPathQuestions");
                });
